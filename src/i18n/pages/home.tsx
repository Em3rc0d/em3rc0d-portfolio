...
const localizedProfessional: Record<Locale, { title: string; summary: string; areas: readonly string[] }> = {
  ...
  es: {
    ...
    summary: "Mi trabajo profesional incluye herramientas para mapear infraestructura y equipos, vistas operativas y mejoras de seguridad. Mi responsabilidad abarca implementación y verificación dentro de un sistema existente.",
    areas: ["Software operativo", "Integraciones reales", "Implementación y seguridad"],
  },
  pt: {
    title: "Software precisa funcionar além da demo.",
    summary: "Meu trabalho profissional inclui ferramentas para mapear infraestrutura e equipamentos, vistas operacionais e melhorias de segurança. Minha responsabilidade abrange implementação e verificação dentro de um sistema existente.",
    areas: ["Software operacional", "Integrações reais", "Implementação e segurança"],
  },
};
