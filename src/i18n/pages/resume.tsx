...
const copy: Record<Locale, {
  ...
  projects: string; education: string; educationDetail: string; skills: string; contact: string; email: string; back: string;
}> = {
  en: {
    ...
    skills: "Technical scope", contact: "Contact", email: "Email ↗", back: "Back to portfolio",
  },
  es: {
    title: "Eduardo Farid Merino Cordova", subtitle: "Software Engineer · Full Stack · Applied AI · Systems",
    ...
    skills: "Alcance técnico", contact: "Contacto", email: "Correo ↗", back: "Volver al portfolio",
  },
  pt: {
    title: "Eduardo Farid Merino Cordova", subtitle: "Software Engineer · Full Stack · Applied AI · Systems",
    ...
    skills: "Escopo técnico", contact: "Contato", email: "E-mail ↗", back: "Voltar ao portfólio",
  },
};
